...
const RELICS = [
  ...
  { id: "antidote", name: "Antidote", labels: ["Buff"], description: "Immune to all Poison damage. 30% resistance to Nature." },
  ...
  { id: "artifact_gluttony", name: "Artifact of Gluttony", labels: ["Support", "Buff"], description: "No longer bite yourself when gluttony strikes. All consumables are 20% more effective." },
  { id: "artifact_greed", name: "Artifact of Greed", labels: ["Stat Boost", "Buff", "Self Debuff"], description: "More gold = more damage (up to 33% at 750 gold). Lose 1-15 gold when damaged." },
  { id: "artifact_judgement", name: "Artifact of Judgement", labels: ["Support", "Buff"], description: "See enemy health bars. Partially reverts Judgement Sin." },
  ...
  { id: "feriun_horn", name: "Feriun Horn", labels: ["Buff", "Fire"], description: "Fire resistance +15%. 40% chance to extinguish burn stacks immediately." },
  ...
  { id: "gumption_amulet", name: "Gumption Amulet", labels: ["Posture", "Armor"], description: "Block with 2H weapons (posture scales 4% Max HP). +10% Armor while blocking. Posture break lasts 2x and deals 2x damage." },
  ...
  { id: "lightning_charm", name: "Lightning Charm", labels: ["Mobility"], description: "Rolls teleport instead. Decreased iframes, increased cooldown. Distance scales off Walkspeed." },
  ...
  { id: "serpent_fang", name: "Serpent's Fang", labels: ["Buff"], description: "Dodging poisons nearby enemies for 2.22 Poison damage/s for 8s. 10s cooldown." },
  ...
  { id: "stormcaller_eye", name: "Stormcaller's Eye", labels: ["Lightning", "Buff"], description: "Critical strikes summon lightning smiting nearby enemies for 20% of crit damage. 20s cooldown." },
  { id: "suspicious_grimoire", name: "Suspicious Grimoire", labels: ["Buff", "Defensive", "Self Debuff"], description: "Spells 33% chance to cast 2x faster. Applies random debuff (2.25 damage/s for 1-5s)." },
  ...
  { id: "tidal_crest", name: "Tidal Crest", labels: ["Buff", "Self Debuff"], description: "+40% Fire/Poison Resistance, -30% Frost Resistance. Lasts 10s, refreshes every 30s." },
  ...
  { id: "windsprint_charm", name: "Windsprint Charm", labels: ["Stat Boost", "Buff", "Mobility", "Self Debuff"], description: "-20% initial walkspeed. Build momentum over 5s to reach 150% speed. Immune to hitstun at max speed." },
  { id: "winter_mittens", name: "Winter Mittens", labels: ["Buff"], description: "Chill stacks half effective. Immune to basic freezes." },
